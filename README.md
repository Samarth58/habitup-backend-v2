...
The project includes isolated end-to-end automated test scripts in the `scripts/` directory. Each script generates isolated per-run test users to ensure repeatable execution:
