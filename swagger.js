      ...
      schemas: {
        ...
        DeviceToken: {
          ...
          properties: {
            id:         { type: 'string', format: 'uuid' },
            user_id:    { type: 'string', format: 'uuid' },
            token:      { type: 'string', example: 'fMeL4x9Q...z8Y1' },
        ...
        NotificationPreferences: {
          ...
          properties: {
            ...
            morningEnabled:   { type: 'boolean', example: true },
            afternoonEnabled: { type: 'boolean', example: true },
            eveningEnabled:   { type: 'boolean', example: true },
            morningTime:      { type: 'string', example: '08:00' },
            afternoonTime:    { type: 'string', example: '13:00' },
